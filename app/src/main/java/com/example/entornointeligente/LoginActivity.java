...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public static String Ip="192.168.0.5:800", E, C;
            ...
            public void onClick(View view) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        response = HttpRequest.get("http://" + Ip + "/Servicio_Proyect/Servicio_usuario/Select_Login.php?usuario=" + mEmailView.getText().toString()
                                + "&contrasena=" + mPasswordView.getText().toString()).body();
    ...
    private boolean isEmailValid(String email) {
        ...
        return email.contains("@") && email.contains(".") && email.equalsIgnoreCase(E);

    }

    private boolean isPasswordValid(String password) {
        //TODO: Replace this with your own logic
        return password.length() >= 4 && password.equalsIgnoreCase(C);
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            for (String credential : DUMMY_CREDENTIALS.get()) {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                Intent ob = new Intent(LoginActivity.this, Principal.class);
                ob.putExtra("nombre",nombre);
                ob.putExtra("correo", C);
                startActivity(ob);
